...
//*******************************************************************************************
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      */
    private $runtime = ['socket' => '', 'selected' => false, 'host' => '', 'queryport' => '10011', 'timeout' => 2, 'debug' => [], 'fileSocket' => '', 'bot_clid' => '', 'bot_name' => ''];
    ...
    /**
      ...
      * @param		int	$time		bantime in seconds (0=unlimited/default)  [optional]
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param 		int	$subsystem	(1: voice, 2: query, 3: filetransfer)
      * @return     array bindingList
      */
    public function bindingList($subsystem = 0)
    {
    ...
    /**
      ...
      * @param		int		$cid		channelID
      * @param		int		$cldbid		clientDBID
      * @param		bool		$permsid	displays permissionName instead of permissionID
     ...
     */
    public function channelGetIconByChannelID($channelID)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
        ...
        if (empty($channelID)) {
            return $this->generateOutput(false, ['Error: empty channelID'], false);
        }
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$name	groupName
      * @param		int	$type   groupDbType [optional] (default: 1)
      * @return     array success
      */
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		  int $cgid	groupID
      * @param		  int $cid	channelID
      * @param		  int $cldbid	clientDBID
      * @return     array success
      */
    public function channelGroupAddClient($cgid, $cid, $cldbid)
    {
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int $cid		channelID [optional]
      * @param		int $cldbid		clientDBID [optional]
      * @param		int $cgid		channelGroupID [optional]
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$scgid	sourceChannelGroupID
      * @param		int	$tcgid	targetChannelGroupID
      * @param		int $name	groupName
      * @param		int	$type	groupDbType
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int $cgid	channelGroupID
      * @param		int $force	forces deleting channelGroup (default: 1)
      * @return     array success
      */
     ...
     * @return array  base64 image
     */
    public function channelGroupGetIconByCGID($channelGroupID)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
        ...
        if (empty($channelGroupID)) {
            return $this->generateOutput(false, ['Error: empty channelGroupID'], false);
        }
        ...
        if ($cgid == -1) {
            return $this->generateOutput(false, ['Error: invalid channelGroupID'], false);
        }
      
        if ($iconID == '0') {
            return $this->generateOutput(false, ['Error: channelGroup has no icon'], false);
        }
    ...
    /**
      ...
      */
    public function channelClientList($cid, $params = null)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int $cid	channelID
      * @param		int $cpid	channelParentID
      * @param		int $order	channelSortOrder
      * @return     array success
      */
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int		$cid		channelID
      * @param		bool		$permsid	displays permissionName instead of permissionID [optional]
     ...
     * @return array  base64 image
     */
    public function clientAvatar($uid)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
        ...
        if (! $check["success"]) {
            return $this->generateOutput(false, ['Error: avatar does not exist'], false);
        }
    ...
    /**
      ...
      * @param		bool	$uid		set true to add -uid param [optional]
      * @return     array clientList
      */
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$start		offset [optional] (Default: 0)
      * @param		int	$duration	limit [optional] (Default: -1)
      * @param		bool	$count		set true to add -count param [optional]
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int		$cldbid 	clientDBID
      * @param		bool		$permsid	set true to add -permsid param [optional]
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int $tcldbid	targetClientDBID
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int $tcldbid targetClientDBID
      * @param		int $fcldbid fromClientDBID
      * @return     array success
      */
    ...
    /**
      ...
      * @return     array success
      */
    public function ftGetFileInfo($cid, $cpw = '', $file)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @param		string	$cid			channelID
      * @param		string	$cpw			channelPassword (leave blank if not needed)
      * @param		int	$seekpos		seekpos (default = 0) [optional]
      * @param		int	$proto			proto (default = NULL) [optional]
      * @return     array	initDownloadFileInfo
      */
    public function ftInitDownload($name, $cid, $cpw = '', $seekpos = 0, $proto = null)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @param		string	$cpw		channelPassword (leave blank if not needed)
      * @param		bool	$overwrite	overwrite	[optional] (default = 0)
      * @param		bool	$resume		resume		[optional] (default = 0)
      * @param		int	$proto		proto (default = NULL) [optional]
      * @return     array	initUploadFileInfo
      */
    public function ftInitUpload($filename, $cid, $size, $cpw = '', $overwrite = false, $resume = false, $proto = null)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$serverftfid	serverFileTransferID
      * @param		bool	$delete			delete incomplete file [optional] (default: true)
      * @return     array success
      */
    ...
    public function getIconByID($iconID)
    {
        ...
        if (empty($iconID) or $iconID == 0) {
            return $this->generateOutput(false, ['Error: empty iconID'], false);
        }
      
        if ($iconID == 100 or $iconID == 200 or $iconID == 300 or $iconID == 500 or $iconID == 600) {
            return $this->generateOutput(false, ['Error: you can\'t download teamspeak default icons'], false);
        }
        ...
        if (! $check["success"]) {
            return $this->generateOutput(false, ['Error: icon does not exist'], false);
        }
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$logLevel	loglevel between 1 and 4
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$lines	between 1 and 100
      * @param		int	$reverse	{1|0} [optional]
      * @param		int	$instance	{1|0} [optional]
      * @param		int	$begin_pos	{1|0} [optional]
    ...
    /**
      ...
      * @return     array success
      */
    public function messageAdd($cluid, $subject, $message)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		string	$messageID		messageID
      * @param		int	$flag			flag {1|0}
      * @return     array messageInformation
      */
    public function messageUpdateFlag($messageID, $flag = 1)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
     ...
     * @param   string|int  $iconID  	[optional] Desired IconID (Must be higher than 1.000.000.000, and lower than 2.147.483.647)
     * @return  array	ftGetFileInfo
     */
    public function uploadIcon($filepath, $iconID = -1)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
        ...
        if ($iconID <= 1000000000 and $iconID <= 2147483647) {
            return $this->generateOutput(false, ['Error: Must be higher than 1.000.000.000, and lower than 2.147.483.647'], false);
        }
        
        if (! file_exists($filepath)) {
            return $this->generateOutput(false, ['Error: file does not exist'], false);
        }
        ...
        try {
            ...
            return $this->generateOutput(false, ['Error: can\'t read file - '.$e->getMessage()], false);
        }
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		bool		$new		[optional] add new parameter
      * @return     array permissionList
      */
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int		$cid		cchannelId
      * @param		int 	$cldbid		clientDbId
      * @param		int 	$permid		permId (Default: 0)
    ...
    /**
      ...
      * @param		int	$tokenid1				groupID
      * @param		int	$tokenid2				channelID
      ...
      */
    public function privilegekeyAdd($tokentype, $tokenid1, $tokenid2, $description = '', $customFieldSet = [])
    {
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$value		Port or ID
      * @param		string	$type		value type ('port', 'serverId') (default='port')
      * @param		bool	$virtual	set true to add -virtual param [optional]
      * @param		string 	$name		set the name of the client before entry (has to be more than 3 characters) [optional]
      * @return     array success
      */
    public function selectServer($value, $type = 'port', $virtual = false, $name = null)
    {
        if (strlen($name) < 3) {
            $name = '';
        } else {
            $name = " client_nickname=".$this->escapeText($name)."";
        }
    ...
    /**
      ...
      */
    public function serverCreate($data = [])
    {
        $settingsString = '';
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int $name	groupName
      * @param		int	$type	groupDbType (0 = template, 1 = normal, 2 = query | Default: 1)
      * @return     array groupId
      */
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$sgtype			serverGroupType
      * @param		array	$permissions	permissions
      * @return     array success
      */
    public function serverGroupAutoAddPerm($sgtype, $permissions)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @return     array success
      */
    public function serverGroupAutoDeletePerm($sgtype, $permissions)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$sgid		groupId
      * @param		bool	$names		set true to add -names param [optional]
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param		int	$ssgid	sourceGroupID
      * @param		int	$tsgid	targetGroupID
      * @param		int $name	groupName
      * @param		int	$type	groupDbType (0 = template, 1 = normal, 2 = query | Default: 1)
      * @return     array groupId
      */
    ...
    /**
      ...
      * @author     Stefan Zehnpfennig
      * @param		int $sgid	serverGroupID
      * @param		int $force 	forces deleting group (Default: 1)
      * @return     array success
      */
     ...
     * @return array  base64 image
     */
    public function serverGroupGetIconBySGID($serverGroupID)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
        ...
        if (empty($serverGroupID)) {
            return $this->generateOutput(false, ['Error: empty serverGroupID'], false);
        }
        ...
        if ($sgid == -1) {
            return $this->generateOutput(false, ['Error: invalid serverGroupID'], false);
        }
      
        if ($iconID == '0') {
            return $this->generateOutput(false, ['Error: serverGroup has no icon'], false);
        }
    ...
    /**
      ...
      *
      * @author     Stefan Zehnpfennig
      * @param      int $type groupDbType (0 = template, 1 = normal, 2 = query) By default get all groups
      * @return     array serverGroupList
      */
    public function serverGroupList($type = null)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @return     array success
      */
    public function serverProcessStop($reasonMessage = null)
    {
    ...
    /**
      ...
      * @return     array success
      */
    public function serverSnapshotDeploy($snapshot, $mapping = false)
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
    ...
    /**
      ...
      * @return     array success
      */
    public function serverStop($sid, $reasonMessage = null)
    {
    ...
    /**
      ...
      * @param		int	$tcid			cid user enters on connect (0 = Default channel) [optional]
    ...
    /**
      ...
      * @return     array	tokenInformation
      */
    public function tokenAdd($tokentype, $tokenid1, $tokenid2, $description = '', $customFieldSet = [])
    {
        if (! $this->runtime['selected']) {
            return $this->checkSelected();
        }
     ...
     * @param	int	$queryport	ts3queryport
     * @param	int	$timeout	socket timeout (default = 2) [optional]
     * @return	void
    */
    ...
    */
    ...
    private function executeCommand($command, $tracert = null)
    {
        ...
        foreach ($splittedCommand as $commandPart) {
            if (! (@fputs($this->runtime['socket'], $commandPart))) {
                ...
                return $this->generateOutput(false, ['Socket closed.'], false);
            }
        }
        do {
            ...
            if (empty($data)) {
                ...
                return $this->generateOutput(false, ['Socket closed.'], false);
            } elseif (strpos($data, 'error id=3329 msg=connection') !== false) {
                $this->runtime['socket'] = $this->runtime['bot_clid'] = '';
    ...
    /**
      ...
      * @param	bool	$keepalive	default false
    ...
    {
        $availTypes = ['textserver', 'textchannel', 'textprivate'];
        $rtnData = ['success' => 0, 'data' => ['invokerid' => '', 'invokeruid' => '', 'invokername' => '', 'msg' => '', 'targetmode' => '']];
